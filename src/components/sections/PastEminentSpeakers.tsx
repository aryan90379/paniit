...
const PAST_SPEAKERS: { image: string; name: string; desc: string; imageFocus?: string }[] = [
  ...
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/abhay-karandikar.jpg', name: 'Sri Abhay Karandikar', desc: 'Member, NITI Aayog' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/mk-stalin.jpg', name: 'Sri MK Stalin', desc: 'Chief Minister, Tamil Nadu' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/v-anantha-nageswaran.jpg', name: 'Sri Dr. V Anantha Nageswaran', desc: 'Chief Economic Advisor, Government of India' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/sudhansh-pant.jpg', name: 'Sri Sudhansh Panth', desc: 'IAS (IITKGP) Chief Secretary Rajasthan' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/navin-mittal.jpg', name: 'Sri Navin Mittal, IAS', desc: 'Special Chief Secretary, Policy, Regulation & Energy at Govt. of Telangana' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/phani-kishan-addepalli.jpg', name: 'Sri Phani Kishan Addepalli', desc: 'Cofounder, Swiggy' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/ankit-mehta.png', name: 'Sri Ankit Mehta', desc: 'CEO, ideaForge' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/tarun-mehta.jpg', name: 'Sri Tarun Mehta', desc: 'Cofounder & CEO, Ather Energy' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/asha-jadeja-motwani.jpg', name: 'Smt. Asha Jadeja Motwani', desc: 'Founder, Motwani Jadeja Family Foundation' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/sharon-pickering.jpg', name: 'Smt. Sharon Pickering', desc: 'Vice-Chancellor and President of Monash University' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/markus-schafer.jpg', name: 'Sri Markus Schäfer', desc: 'Board of Directors Member & CTO Mercedes-Benz Group AG' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/naotaka-nishiyama.jpg', name: 'Sri Naotaka Nishiyama', desc: 'Founder & CEO, Talendy' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/lal-chand-bisu.jpg', name: 'Sri Lal Chand Bisu', desc: 'Cofounder & CEO Kuku FM' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/venkat-padmanabhan.jpg', name: 'Sri Venkat Padmanabhan', desc: 'Managing Director, Microsoft Research India' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/harsh-jain.jpg', name: 'Sri Harsh Jain', desc: 'Cofounder & COO, Groww' },
  { image: 'https://d3liyurciwi0wb.cloudfront.net/speakers/legacy/abhishek-bansal.jpg', name: 'Sri Abhishek Bansal', desc: 'Cofounder & CEO, Shadowfax' },
];
