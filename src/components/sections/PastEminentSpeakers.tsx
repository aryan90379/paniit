...
const PAST_SPEAKERS = [
  { image: '/past-speakers/modi.jpg', name: 'Sri Narendra Modi', desc: "Hon'ble Prime Minister, India" },
  { image: '/past-speakers/kalam.jpg', name: 'Dr. APJ Abdul Kalam', desc: 'Former President, India' },
  { image: '/past-speakers/manmohan.jpg', name: 'Dr. Manmohan Singh', desc: 'Former Prime Minister, India' },
  { image: '/past-speakers/ravisankar.jpg', name: 'Gurudev Sri Sri Ravi Shankar', desc: '' },
  { image: '/past-speakers/clinton.jpg', name: 'Sri Bill Clinton', desc: 'Former President, USA' },
  { image: '/past-speakers/gates.jpg', name: 'Sri Bill Gates', desc: 'Chairman, Gates Foundation' },
  { image: '/past-speakers/murthy.jpg', name: 'Sri NR Narayana Murthy', desc: 'Founder, Infosys' },
  { image: '/past-speakers/parrikar.jpg', name: 'Sri Manohar Parrikar', desc: 'Former Chief Minister, Goa' },
  { image: '/past-speakers/amartya.jpg', name: 'Sri Amartya Sen', desc: 'Nobel Prize Winner and Professor, Harvard' },
  { image: '/past-speakers/nilekani.jpg', name: 'Sri Nandan M. Nilekani', desc: 'Co-Founder & Chairman, Infosys' },
  { image: '/past-speakers/gehlot.jpg', name: 'Sri Thawar Chand Gehlot', desc: 'Governor of Karnataka' },
  { image: '/past-speakers/khosla.jpg', name: 'Sri Vinod Khosla', desc: 'Founder & MD, Khosla Ventures' },
  { image: '/past-speakers/kiran.jpg', name: 'Sri A S Kiran Kumar', desc: 'Former Chairman, ISRO' },
  { image: '/past-speakers/bass.jpg', name: 'Sri Carl Bass', desc: 'Former President & CEO, Autodesk' },
  { image: '/past-speakers/gadkari.jpg', name: 'Sri Nitin Gadkari', desc: 'Union Minister, Road Transport & Highways' },
  { image: '/past-speakers/goyal.jpg', name: 'Sri Piyush Goyal', desc: 'Union Minister, Commerce and Industry of India' },
  { image: '/past-speakers/karandikar.jpg', name: 'Sri Abhay Karandikar', desc: 'Member, NITI Aayog' },
  { image: '/past-speakers/stalin.jpg', name: 'Sri MK Stalin', desc: 'Chief Minister, Tamil Nadu' },
