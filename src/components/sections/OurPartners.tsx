...
export default function OurPartners() {
  return (
    <section id="our-partners" className="py-20 md:py-24 bg-paper relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-7xl relative z-10">
        ...
        {/* Section Heading */}
        <SectionHeading title="Our Partners" className="mb-12 md:mb-16" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 md:gap-8 max-w-6xl mx-auto">
          {PARTNER_LOGOS.map((logoUrl, i) => (
            <motion.div
              ...
              className="aspect-square relative bg-white flex items-center justify-center rounded-2xl p-4 border border-[#06206A]/8"
            >
