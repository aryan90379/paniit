...
const COMMITTEE_ITEMS: ChromaItem[] = [
  // Office Bearers
  { image: PLACEHOLDER, title: 'Prabhat Kumar, IRS', subtitle: 'Chairman', borderColor: '#153063', gradient: 'linear-gradient(145deg, #1530631a, #ffffff)' },
  { image: PLACEHOLDER, title: 'Dr. Amitabh Ranjan', subtitle: 'Vice Chairman', borderColor: '#E13926', gradient: 'linear-gradient(180deg, #E139261a, #ffffff)' },
  ...
  // Advisors
  { image: PLACEHOLDER, title: 'Prof. V. Kamakoti', subtitle: 'Director, IIT Madras', borderColor: '#153063', gradient: 'linear-gradient(165deg, #1530631a, #ffffff)' },
  { image: PLACEHOLDER, title: 'Dr. K. N. Satyanarayana', subtitle: 'Director, IIT Tirupati', borderColor: '#E13926', gradient: 'linear-gradient(195deg, #E139261a, #ffffff)' },
  ...
  { image: PLACEHOLDER, title: 'Rajesh Kumar Dasari', subtitle: 'Co-Chair', borderColor: '#153063', gradient: 'linear-gradient(135deg, #1530631a, #ffffff)' },
  { image: PLACEHOLDER, title: 'Sudhakar Gande', subtitle: 'Core Committee', borderColor: '#E13926', gradient: 'linear-gradient(165deg, #E139261a, #ffffff)' },
  ...
  { image: PLACEHOLDER, title: 'Dr. Gundala Nagaraju', subtitle: 'Core Committee', borderColor: '#153063', gradient: 'linear-gradient(145deg, #1530631a, #ffffff)' },
  // Others
  { image: PLACEHOLDER, title: 'Prof. Murali Krishna Iyyanki', subtitle: 'Committee Member', borderColor: '#E13926', gradient: 'linear-gradient(180deg, #E139261a, #ffffff)' },
  ...
  { image: PLACEHOLDER, title: 'Praveen Kumar', subtitle: 'Committee Member', borderColor: '#153063', gradient: 'linear-gradient(165deg, #1530631a, #ffffff)' },
  { image: PLACEHOLDER, title: 'Phani Arega', subtitle: 'Committee Member', borderColor: '#E13926', gradient: 'linear-gradient(195deg, #E139261a, #ffffff)' },
  ...
  { image: PLACEHOLDER, title: 'Dr. Anjanna Matta', subtitle: 'Committee Member', borderColor: '#153063', gradient: 'linear-gradient(135deg, #1530631a, #ffffff)' },
  { image: PLACEHOLDER, title: 'C P Madhusudan', subtitle: 'Committee Member', borderColor: '#E13926', gradient: 'linear-gradient(165deg, #E139261a, #ffffff)' },
  ...
  { image: PLACEHOLDER, title: 'Kshitij Tiwari', subtitle: 'Committee Member', borderColor: '#153063', gradient: 'linear-gradient(145deg, #1530631a, #ffffff)' },
  { image: PLACEHOLDER, title: 'Sanskreeti Raj', subtitle: 'Committee Member', borderColor: '#E13926', gradient: 'linear-gradient(180deg, #E139261a, #ffffff)' },
