...
const SPEAKER_ITEMS: ChromaItem[] = [
  ...
  { image: PLACEHOLDER, title: 'Prof. Balaram Ravindran', subtitle: 'Head of Data Science, IIT Madras', borderColor: '#153063', gradient: 'linear-gradient(145deg, #1530631a, #0a0a0a)' },
  { image: PLACEHOLDER, title: 'Prof. Arun Tangirala', subtitle: 'Dean, CDO, IIT Tirupati', borderColor: '#E13926', gradient: 'linear-gradient(180deg, #E139261a, #0a0a0a)' },
  // Industry Leaders
  ...
  { image: PLACEHOLDER, title: 'Arun Ramchandani', subtitle: 'Sr VP, L&T', borderColor: '#E13926', gradient: 'linear-gradient(195deg, #E139261a, #0a0a0a)' },
  ...
  { image: PLACEHOLDER, title: 'Sri Shekar Reddy', subtitle: 'CMD, Crux Biotech', borderColor: '#153063', gradient: 'linear-gradient(145deg, #1530631a, #0a0a0a)' },
  { image: PLACEHOLDER, title: 'Sri Ram Bandi', subtitle: 'Founder & CEO, Styrax', borderColor: '#E13926', gradient: 'linear-gradient(180deg, #E139261a, #0a0a0a)' },
